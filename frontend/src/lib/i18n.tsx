...
const EN: Dict = {
  ...
  'dashboard.overtimeAllTime': 'All-time balance',
  ...
  'reports.soll': 'Expected',
  'reports.ist': 'Actual',
  'reports.saldo': 'Balance',
  'reports.breakRequired': 'required',
  'reports.monthlyBalance': 'Monthly balance',
  'reports.cumulativeBalance': 'Cumulative',
...
const DE: Dict = {
  ...
  'dashboard.overtimeAllTime': 'Gesamt-Saldo (all-time)',
  ...
  'reports.ist': 'Ist',
  'reports.saldo': 'Saldo',
  'reports.breakRequired': 'Pflichtpause',
  'reports.monthlyBalance': 'Monatssaldo',
  'reports.cumulativeBalance': 'Gesamtsaldo',
  'reports.last12Months': 'Letzte 12 Monate',
  'reports.warningOver10h': '>10h',
